var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-1z0gxvs");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-1z0gxvs");
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("start", /*timerStarts*/ ctx[1]);
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Washing Hand App";
    			t1 = space();
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/" class="svelte-1r7wcu1">Picture source</a> 
<a href="https://freesound.org/people/metrostock99/sounds/345086/" class="svelte-1r7wcu1">Sound source</a>`;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [audio, timerStarts, stopAudio, audio_1_binding];
    }
